...
export var articleSample1: Article = new Article('Google Pixel Phones to be Unveiled October 4' ,`The firm may also launch its voice-activated AI home audio speaker, a VR headset and a 4K Chromecast

Google will unveil its latest Pixel smartphones on October 4, the firm has suggested through a teaser website.

It is believed the Nexus brand name will be dropped in favour of two new models: <b>the Pixel and the Pixel XL</b>.

Current rumours around the devices – which have been codenamed <b>Sailfish and Marlin</b> – say the devices will be 5-inch and 5.5-inch phones. At Google's developer conference in May CEO Sundar Pichai hinted that the new line would includes additional Google features built on top of the Android operating system. As such, Pixel is expected to become a premium brand.
...
Rumoured to be launching that day will be a Google virtual reality headset, under the guise of the <b>Google Daydream project</b>; a 4K Chromecast, and its highly anticipated AI personal assistant device.
...
The device will use a <b>Google Assistant</b>, which is being built into a new Google messages app called <b>Allo</b> – which is rumoured to be launching before the October event. "<i>With a simple voice command, you can ask Google Home to play a song, set a timer for the oven, check your flight, or turn on your lights</i>," the firm said at the time.
